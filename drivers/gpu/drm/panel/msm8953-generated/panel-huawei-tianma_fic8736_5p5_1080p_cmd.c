...
static int tianma_fic8736_5p5_on(struct tianma_fic8736_5p5 *ctx)
{
	...
	dsi_generic_write_seq(dsi, 0xff, 0x87, 0x36, 0x01);
	dsi_generic_write_seq(dsi, 0x00, 0x80);
	dsi_generic_write_seq(dsi, 0xff, 0x87, 0x36);
	dsi_generic_write_seq(dsi, 0x00, 0x00);
	dsi_generic_write_seq(dsi, 0x1c, 0x00);
	dsi_generic_write_seq(dsi, 0x44, 0x03, 0xff);
...
static int tianma_fic8736_5p5_off(struct tianma_fic8736_5p5 *ctx)
{
	...
	dsi_dcs_write_seq(dsi, 0xff, 0x87);
	dsi_dcs_write_seq(dsi, 0x00, 0x01);
	dsi_dcs_write_seq(dsi, 0xff, 0x36);
	dsi_dcs_write_seq(dsi, 0x00, 0x02);
	...
	dsi_dcs_write_seq(dsi, 0xff, 0x36);
	dsi_dcs_write_seq(dsi, 0x00, 0x00);
	dsi_dcs_write_seq(dsi, 0xf7, 0x5a);
	dsi_dcs_write_seq(dsi, 0x00, 0x01);
	dsi_dcs_write_seq(dsi, 0xf7, 0xa5);
	dsi_dcs_write_seq(dsi, 0x00, 0x02);
	dsi_dcs_write_seq(dsi, 0xf7, 0x87);
	dsi_dcs_write_seq(dsi, 0x00, 0x03);
	dsi_dcs_write_seq(dsi, 0xf7, 0x36);
	msleep(200);
	dsi_dcs_write_seq(dsi, 0x00, 0x00);
	msleep(200);
...
static int tianma_fic8736_5p5_remove(struct mipi_dsi_device *dsi)
{
