...
static int ctc_otm1906c_5p5_on(struct ctc_otm1906c_5p5 *ctx)
{
	...
	mipi_dsi_generic_write_seq(dsi, 0x44, 0x07, 0x70);
...
static int ctc_otm1906c_5p5_enable(struct drm_panel *panel)
{
	struct ctc_otm1906c_5p5 *ctx = to_ctc_otm1906c_5p5(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
...
static int ctc_otm1906c_5p5_disable(struct drm_panel *panel)
{
	struct ctc_otm1906c_5p5 *ctx = to_ctc_otm1906c_5p5(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
				      ...
				      struct drm_connector *connector)
{
	...
	mode = drm_mode_duplicate(connector->dev, &ctc_otm1906c_5p5_mode);
	if (!mode)
		return -ENOMEM;
...
static const struct drm_panel_funcs ctc_otm1906c_5p5_panel_funcs = {
	...
	.enable = ctc_otm1906c_5p5_enable,
	.unprepare = ctc_otm1906c_5p5_unprepare,
	.disable= ctc_otm1906c_5p5_disable,
...
static const struct of_device_id ctc_otm1906c_5p5_of_match[] = {
	{ .compatible = "huawei,ctc_otm1906c_5p5_1080p_cmd" }, // FIXME
	{ /* sentinel */ }
};
