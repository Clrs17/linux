...
static int tianma_focal8716_5p5_on(struct tianma_focal8716_5p5 *ctx)
{
	...
	dsi_generic_write_seq(dsi, 0x99, 0x00, 0x00);
	usleep_range(5000, 6000);
...
static int tianma_focal8716_5p5_off(struct tianma_focal8716_5p5 *ctx)
{
	...
	dsi_generic_write_seq(dsi, 0x00, 0x00);
	dsi_generic_write_seq(dsi, 0xf7, 0x5a, 0xa5, 0x87, 0x16);
	usleep_range(5000, 6000);
...
static int tianma_focal8716_5p5_remove(struct mipi_dsi_device *dsi)
{
...
static const struct of_device_id tianma_focal8716_5p5_of_match[] = {
	{ .compatible = "huawei,tianma_focal8716_5p5_1080p_video" }, // FIXME
	{ /* sentinel */ }
};
