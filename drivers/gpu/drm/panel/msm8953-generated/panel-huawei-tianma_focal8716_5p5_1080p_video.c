...
static int tianma_focal8716_5p5_enable(struct drm_panel *panel)
{
	struct tianma_focal8716_5p5 *ctx = to_tianma_focal8716_5p5(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
...
static int tianma_focal8716_5p5_disable(struct drm_panel *panel)
{
	struct tianma_focal8716_5p5 *ctx = to_tianma_focal8716_5p5(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
...
static const struct drm_panel_funcs tianma_focal8716_5p5_panel_funcs = {
	...
	.enable = tianma_focal8716_5p5_enable,
	.unprepare = tianma_focal8716_5p5_unprepare,
	.disable= tianma_focal8716_5p5_disable,
